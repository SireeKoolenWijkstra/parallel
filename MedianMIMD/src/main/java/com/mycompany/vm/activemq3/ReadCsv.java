...
public class ReadCsv {
    ...
    private static final String FILE_PATH = "..\\resources\\winequality-white-part-1.csv";
...
//        System.out.printf(format, "Length of list VM3: ", overallQuality.size());
        System.out.printf(format, "ReadFile time VM_3: ", (System.currentTimeMillis() - start) + " ms");
